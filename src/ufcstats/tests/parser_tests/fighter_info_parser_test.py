...
from ufcstats.entities.fighter import Fighter
from ufcstats.ufcstats.parsers.fighter_info_parser import FighterInfoParser
from ufcstats.tests import FIGHTER_RESPONSE_VALID_PATH
